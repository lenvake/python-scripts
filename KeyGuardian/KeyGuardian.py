...
def getCredentials():
    websiteName = input(
        "Which website do you want to save your data from?")
...
def helpSection():
    print()
    print(
        "Right now,you are viewing the help section of KeyGuardian"
    )
...
print(
    "Welcome to KeyGuardian Password Manager! KeyGuardian is your personal guardian that helps you control access to your accounts and information. Whether it's online banking, email accounts, social media, or other sensitive data, KeyGuardian securely manages your passwords while providing convenient access to them."
)
